...
const GATES = [
  { days:30,  title:'Activación Fundacional',       titleEN:'Foundational Activation',     color:'#E55B4D', bg:'#FBE8E2', status:'in_progress', exit:'DGSFP inscripción verificada públicamente + vumigroup.com copy corregido + 3 brokers P0 reunión inicial completada', exitEN:'DGSFP registration publicly verified + vumigroup.com copy corrected + 3 P0 brokers initial meeting completed', owner:'VUMI Europe + Strategy Lead', blockers:['Confirmar inscripción DGSFP en registro público','Corregir copy vumigroup.com Spain exclusion'], blockersEN:['Confirm DGSFP registration in public registry','Fix vumigroup.com Spain exclusion copy'], initiatives:['Mystery shopping pricing competidores (perfiles A, B, C)','Outreach brokers P0: C1 Broker, Medicorasse, Espabrok','Ficha producto VUMI Euro Health EN/ES para brokers','Confirmación modelo: ¿delegado físico España?'], initiativesEN:['Competitor pricing mystery shopping (profiles A, B, C)','Outreach P0 brokers: C1 Broker, Medicorasse, Espabrok','VUMI Euro Health product sheet EN/ES for brokers','Model confirmation: physical delegate in Spain?'] },
  { days:60,  title:'Validación Canal Broker',        titleEN:'Broker Channel Validation',    color:'#0033A0', bg:'#EEF2FF', status:'not_started', exit:'5+ brokers Tier 1 con propuesta aceptada (NDA o carta de intención) + price corridor VUMI definido vs competencia', exitEN:'5+ Tier 1 brokers with accepted proposal (NDA or letter of intent) + VUMI price corridor defined vs competition', owner:'Strategy + VUMI Commercial', blockers:[], blockersEN:[], initiatives:['Pricing corridor VUMI vs competidores — decisión interna','Material broker: battle cards por competidor (Bupa, Allianz, AXA, Cigna)','Outreach brokers P1 (segunda oleada)','Rating AM Best: decisión go/no-go'], initiativesEN:['VUMI vs competitors pricing corridor — internal decision','Broker material: battle cards per competitor (Bupa, Allianz, AXA, Cigna)','P1 broker outreach (second wave)','AM Best rating: go/no-go decision'] },
