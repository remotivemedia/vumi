    ...
    <div style={{ maxWidth:1100 }}>
      <FadeIn>
        <div style={{ marginBottom:24 }}>
          ...
          <h1 style={{ fontFamily:"'Montserrat',sans-serif", fontWeight:700, fontSize:26, letterSpacing:'-0.025em', color:'#2C3539', marginBottom:6 }}>Diáspora LatAm en España — 1,09M+</h1>
          <p style={{ fontSize:13, color:'#6B7785', maxWidth:720, lineHeight:1.6 }}>Datos verificados INE Censo Anual 2025, OPI/MITES, SJM. Objetivo VUMI: profesionales HNW y clase media-alta con propensión a seguro privado premium.</p>
        </div>
      </FadeIn>
      ...
      <FadeIn delay={0.05}>
        <div style={{ ...S.card, marginBottom:24 }}>
          ...
          <div style={{ marginTop:8, fontSize:11, color:'#6B7785' }}>Fuente: INE Censo Anual 2025 (30-abr-2025) · OPI · Cifras = nacionalidad empadronada; nacidos en país de origen son ~50-60% superiores.</div>
        </div>
      </FadeIn>
            ...
            <div style={{ ...S.card, marginBottom:20, borderTop:`4px solid ${aud.color}` }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20 }}>
                <div>
                  ...
                  {[{k:'Educación superior',v:aud.higherEdu},{k:'Perfil edad',v:aud.ageProfile},{k:'Tier socioeconómico',v:aud.tier},{k:'Nacionalizaciones 2024',v:aud.nationalizations}].map(({k,v}) => (
